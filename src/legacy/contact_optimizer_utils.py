...
def _check_normals_not_parallel(contacts, angle_tolerance=5.0):
    """
...
# %% [markdown]
# fat triangle, 3  mmiddle vs 3 to covver torque => MPC/PIID ccode to  seee the valuee of translational vs rotational (elsu early game, so weak, pro and noob are the same, prefer pro so no die)
# boot, 4 good vs 4 bad => threshold of holonomic (ying full item vs 2 item)
# boot, good, MPC vs PID ((ying, pro vs noob player))
# 
# 
# stream png or data
# 
